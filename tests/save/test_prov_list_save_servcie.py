...
class TestProvListSaveService(TestModelListSaveService):
    ...
    def test_save_restore_provenance_specific_model(self):
        ...
        # TODO define
        dataset_paths = [
                os.path.join(FILE_PATH, '../example_files/data/dummy_battery_data/data_set_1'),
                os.path.join(FILE_PATH, '../example_files/data/dummy_battery_data/data_set_2'),
                os.path.join(FILE_PATH, '../example_files/data/dummy_battery_data/data_set_3')
        ]
